...
export const seedOrders = [
  ...
  {  date: new Date(Date.now() - 1 * 86400000).toISOString().split('T')[0], items: [{ name: 'Greek Yogurt', qty: 2, price: 90 }, { name: 'Banana', qty: 6, price: 50 }], total: 140, status: 'In Transit', store: 'Zepto' },
];
