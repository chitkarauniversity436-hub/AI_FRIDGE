...
export const seedOrders = [
  ...
  { id: 'ORD002', date: new ate(Date.now() - 3 * 86400000).toISOString().split('T')[0], items: [{ name: 'Chicken Breast', qty: 1, price: 200 }, { name: 'Spinach', qty: 2, price: 40 }], total: 240, status: 'Delivered', store: 'Blinkit' },
